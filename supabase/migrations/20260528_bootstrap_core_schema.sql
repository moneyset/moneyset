-- =============================================================================
-- MONEYSET core schema bootstrap (idempotent)
-- Run in Supabase Dashboard → SQL Editor if migrations were never applied.
-- Safe to re-run on partial or empty databases.
-- =============================================================================
...
-- Tier fields are service-role only (no client UPDATE policy)
